...
export function DecorativePanel() {
  return (
    <div className="relative hidden overflow-hidden bg-linear-to-br from-emerald-600 via-teal-600 to-green-700 lg:flex lg:flex-col lg:justify-between">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="animate-pulse-soft absolute left-[50%] top-[8%] size-2 rounded-full bg-emerald-200/60" />
        <div className="animate-pulse-soft absolute left-[70%] top-[45%] size-1.5 rounded-full bg-teal-200/50 delay-3" />
        <div className="animate-pulse-soft absolute left-[30%] top-[65%] size-2 rounded-full bg-green-200/40 delay-5" />
        <div className="animate-pulse-soft absolute left-[80%] top-[75%] size-1.5 rounded-full bg-emerald-200/50 delay-1" />

        {/* Large blurred orbs */}
        <div className="absolute -left-20 -top-20 size-72 rounded-full bg-emerald-400/20 blur-3xl" />
        <div className="absolute -bottom-20 -right-20 size-72 rounded-full bg-green-400/20 blur-3xl" />
      </div>
      ...
      <div className="relative z-10 px-10">
        <blockquote className="max-w-md space-y-4">
          <div className="flex gap-1 text-emerald-200/60">
            {[...Array(5)].map((_, i) => (
              <svg
                key={i}
